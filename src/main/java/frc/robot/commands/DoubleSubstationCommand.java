...
public class DoubleSubstationCommand extends SequentialCommandGroup {
  /** Creates a new DoubleSubstationCommand. */
  public DoubleSubstationCommand(RotationSubsystem rotationSubsystem, IntakeSubsystem intakeSubsystem,
